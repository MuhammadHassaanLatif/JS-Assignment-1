...
document.getElementById("alertName").onclick = function () {
    let myName = "   MUHAMMAD HASSAAN LATIF";
    alert(myName);
    document.getElementById("output-box").innerHTML = " ";
...
document.getElementById("calculateNumbers").onclick = function () {
    let statement = 45 / 3 + 16 * 5 - (1 + 2)
    document.getElementById("input-box").innerHTML = "let statement = 45 / 3 + 16 * 5 - (1 + 2)";
